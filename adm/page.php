...
<div id="container">
   ...
   <div class="slides-container width static-slide">
        <div id="slides">
            <div>
			...
			<p style="text-align:center;"><a href="#" class="button button-slider">Lorem ipsum dolor</a></p>
        ...
        <aside class="sidebar big-sidebar right-sidebar">
            ...
            <ul>	
               <li>
				...
				<ul>
					<li><a class="selected" href="page.html">Static slide page</a></li>
    ...
    <footer>
        <div class="footer-content width">
 	    ...
 	    <ul>
            ...
            <ul class="endfooter">
            	<li><h4>Suspendisse</h4></li>
                <li>Integer mattis blandit turpis, quis rutrum est. Maecenas quis arcu vel felis lobortis iaculis fringilla at ligula. Nunc dignissim porttitor dolor eget porta. </li>
            </ul>
