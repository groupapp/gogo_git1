<?php
	...
	elseif($action == "del") {
	 ...
	 elseif ($action == "add") {
		$strSQL		= ("INSERT INTO Customers (IsActive,Member_level,Is_VIP_Member,TotalPointsEarned,LoginID,LoginPassword,ReceiveEmail,HowDidYouFindUs,CreditAmount,PenaltyAmount,MemoOnCredit
