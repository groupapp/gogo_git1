...
?>
    ...
    <!-- sideMenu -->
		...
		<div id="contwrapper">
			<div id="title">
				Manage Discount Rates by Order Quantities
			</div>
			<div id="sub1">
...
?>
						<tr>
							...
							<td class="general"><a href="Manage_QuantityDiscounts.php?act=view&aid=<?php echo $data["QD_ID"]?>"><?php echo $data["QuantityDiscountName"];?></a></td>
<?php 
		$DB2 = new myDB;
...
<?php 
			...
			}else if($data2["UpperQty"] > $data2["LowerQty"]){
...
?>							
							...
							<td class="general_c"><?php if($data2["DiscountPercentage1"]>0)echo $data2["DiscountPercentage1"]."%";?></td>
<?php 	
			$count++;
		}
//		echo $count."<br/>";
...
?>
							...
							<td></td>
<?php 	}?>							
							<td class="general_c"><a href="Manage_QuantityDiscounts_action.php?action=del&id=<?php echo $data["QD_ID"];?>">Delete</a></td>
						</tr>
<?php 
	$numrows--;
	}
?>
				...
				?>
				<form name="form2" method="post" action="Manage_QuantityDiscounts_action.php">
					<?php 
...
//		echo $strSQL2."<br/>";
		while ($data2 = $DB2->fetch_array($DB2->res)){
?>
												<td class="general_2"><input type="text" name="LowerQty<?php echo $num;?>" value="<?php if($data2["LowerQty"]>0)echo $data2["LowerQty"];?>" class="box" /></td>
												<td class="general_2"><input type="text" name="UpperQty<?php echo $num;?>" value="<?php if($data2["UpperQty"]>0)echo $data2["UpperQty"];?>" class="box" /></td>
												<td class="general_2"><input type="text" name="DiscountPercentage<?php echo $num;?>" value="<?php if($data2["DiscountPercentage1"]>0)echo $data2["DiscountPercentage1"];?>" class="box" /></td>
<?php 	
			$num++;
		}
		for($num; $num<=6; $num++){
