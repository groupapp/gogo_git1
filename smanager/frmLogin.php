...
<div id="loginWrapper">
    ...
    <div class="loginWrap">
		<p>SSL is activated. Please connect using the following link to<br><a href="https://lemontreeclothing.com/smanager/">into secure mode (https://)</a> </p>
        <form method="post" action="adminmember_action.php">
        <table width="360">
            
			<tr>
                <td style="background-color: gold; padding: 8px; text-align: center; border: 1px solid #999;">LOG IN</td>
            </tr>
            <tr>
