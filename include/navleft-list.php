...
?>						
						...
						<input type="hidden" id="BrandName" name="BrandName" value="<?php echo !empty($nBrandName)?>">
						<input type="hidden" id="Player" name="Player" value="<?php echo !empty($nPlayer)?>">
						<input type="hidden" id="League" name="League" value="<?php echo !empty($nLeague)?>">
						<input type="hidden" id="Country" name="Country" value="<?php echo !empty($nCountry)?>">
						<input type="hidden" id="ColorIDs" name="ColorIDs" value="<?php echo !empty($nColorIDs)?>">
						<input type="hidden" id="SizeChartID" name="SizeChartID" value="<?php echo !empty($nSizeChartID)?>">
						<input type="hidden" id="Size" name="Size" value="<?php echo !empty($nSize)?>">
						<input type="hidden" id="ForMenOrWomen" name="ForMenOrWomen" value="<?php echo !empty($nForMenOrWomen)?>">
						<dl>
							<dt>Price Range : <span type="text" id="amount" style="color: #fff; font-weight: bold;"></span></dt>
							<dd style="width:145px;padding-left:0px;"><div id="slider-range"></div></dd>
						</dl>	
...
<?php
				...
				//print_r($strSQL);	
						...
						if ($CDB->rows > 0) {
							...
							while($data = $CDB->fetch_array($CDB->res)) {							
								echo "<dd><a href=\"?c1=".$c1."&c2=".$data['Cat2ID']."&BrandName=".!empty($nBrandName)."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&ForMenOrWomen=".!empty($nForMenOrWomen)."&ColorIDs=".!empty($nColorIDs)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($nSizeChartID)."&Size=".!empty($nSize)."\">".$data['Cat2Name']." (".$data['cat2cnt'].")</a></dd>";
							}
							echo "</dl>";
						}
				...
				//print_r($bstrSQL);	
						...
						if ($CDB->rows > 0) {
							Echo "<dl><dt>Brand</dt>";
							while($data = $CDB->fetch_array($CDB->res)) {							
								echo "<dd><a href=\"?c1=".!empty($c1)."&c2=".!empty($c2)."&BrandName=".!empty($data['BrandName'])."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&ForMenOrWomen=".!empty($nForMenOrWomen)."&ColorIDs=".!empty($nColorIDs)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($nSizeChartID)."&Size=".!empty($nSize)."\">".$data['BrandName']." (".$data['brandcnt'].")</a></dd>";
							}
							echo "</dl>";
						}
						/*
	...
	*/					
					...
					//print_r($strSQL);	
						...
						if ($CDB->rows > 1) {
							...
							Echo "<dl><dt>Size</dt>";
							while($data = $CDB->fetch_array($CDB->res)) {							
								echo "<dd><a href=\"?c1=".!empty($c1)."&c2=".!empty($c2)."&ColorIDs=".!empty($nColorIDs)."&BrandName=".!empty($nBrandName)."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($data['SizeChartID'])."&Size=".!empty($data['Size'])."\">".$data['Size']." (".$data['Sizecnt'].")</a></dd>";
							}
							if(!empty($smore)==0)
							{
								if($CDB->rows<5)
									echo "<dd><a href=\"?c1=".!empty($c1)."&c2=".!empty($c2)."&ColorIDs=".!empty($nColorIDs)."&BrandName=".!empty($nBrandName)."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($data['SizeChartID'])."&Size=".!empty($data['Size'])."\"></a></dd>";
								else
									echo "<dd><a href=\"?c1=".!empty($c1)."&c2=".!empty($c2)."&ColorIDs=".!empty($nColorIDs)."&BrandName=".!empty($nBrandName)."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($data['SizeChartID'])."&Size=".!empty($data['Size'])."&smore=1\">More...</a></dd>";
							}
							else
								echo "<dd><a href=\"?c1=".!empty($c1)."&c2=".!empty($c2)."&ColorIDs=".!empty($nColorIDs)."&BrandName=".!empty($nBrandName)."&Player=".!empty($nPlayer)."&League=".!empty($nLeague)."&Country=".!empty($nCountry)."&minprice=".!empty($nminprice)."&maxprice=".!empty($nmaxprice)."&SizeChartID=".!empty($data['SizeChartID'])."&Size=".!empty($data['Size'])."&smore=1\">Less...</a></dd>";
						...
						if (!empty($nmaxprice)==0)
							$nmaxprice=$rmaxprice;
						if (!empty($nminprice)==0)
							$nminprice=0;	
						    $rmaxprice=$rmaxprice;
}
...
<?php
									...
									for ($i=1; $i<=count($subMenu); $i++) {
										...
										if (count(${$subMenu[$i-1][2]})) {
											echo "<ul class=\"level1\" style=\"display: block\">";
...
?>
							...
							<div class="advanced-search-title" ><!--class="block block-cart"-->
								<div class="block-title"><strong><span><h2>My Cart</h2></span></strong></div>
								<div class="block-content">
<?php
	// Mini cart summary
...
?>								
								...
								<div class="actions">
									...
									<a href="https://lemontreeclothing.com/?page=checkout" ><input type="button" class="button" value="Checkout"></a>
								</div>
