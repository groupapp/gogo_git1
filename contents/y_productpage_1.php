		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				-->
					...
					<div class="main-col-pro" style="margin-bottom:100px;">
						<div class="page-path">
							<ul>
						...
						<div>
							...
							<div class="row">
								<form action="" method="post" id="" name="" onsubmit="return false">
									...
									<div class="product-imgbox col-lg-6">
									...
									<div class="product-shop col-lg-offset-0 col-lg-4">
...
?>	
												...
												<!--<dd>
													<div class="jqTransformSelect">-->
														...
														<!--<select name="color" id="color">    rel="<?php echo $i+1?>"-->
						<table> 
						<tr>
...
?>
											...
											<div class="price-options" style="display:block">
												<p>(<?php echo "<span id=\"sale-price\">$".$data["UnitPriceOnSale"]."</span> <span id=\"alt-price\">".$data["UnitPriceOnSale"]."</span>";?>)</p>
											</div>
