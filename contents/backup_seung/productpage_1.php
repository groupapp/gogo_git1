		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				-->
					...
					<div class="main-col-pro container" style="margin-bottom:100px;">
						<div class="page-path">
							<ul>
						...
						<div>
							...
							<div class="row">
								<form action="" method="post" id="" name="" onsubmit="return false">
									...
									<div class="product-imgbox col-md-offset-1 col-md-6 col-xs-12">
									
											
										<!-- Insert to your webpage where you want to display the slider -->
										<div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:520px;margin:0px auto 86px;">
											<div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
												...
												?>												
													<li><img src="<?php echo PRODUCT_IMAGE_PATH.$data["Picture".$i];?>" alt="PRODUCT IMG" /></li>
												<?php
														}
													}
												?>
...
//					
				...
				$sizes = $DB->getSizeRun($data["SizeChartID"]);
					$DB7 = new myDB;
					$smallSQL1 = "SELECT * FROM SizeCharts WHERE `SizeChartID` = ".$data["SizeChartID"];
					//echo $smallSQL1;
					$DB7->query($smallSQL1);
					if ($DB7->rows) {
...
<?php 													
												...
												$tsize=  $data7["Size1"].$data7["Size2"].$data7["Size3"].$data7["Size4"].$data7["Size5"].$data7["Size6"].$data7["Size7"];
...
<?php 	} ?>
												...
												<p>Price:<?php echo "<span style=\"color: #F35;font-size: 18px;font-weight: bold;\" id=\"sale-price\">$".$data["UnitPriceOnSale"]."</span> <span style=\"color: #B2B2B2;font-size: 14px;font-weight: normal;text-decoration: line-through;\" id=\"alt-price\">".$data["UnitPrice"]."</span>";?></p>
                                                                                                </div>
                                                                                                <p class="clear"></p>
