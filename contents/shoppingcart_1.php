...
<?php 
	if (is_array(!empty($_SESSION['cart']))) {
?>													
...
<?php
	...
	// don if ($_POST['sstate']=="CA" || $_POST['local_tax'] > 0) {
?>
											<!--<tr>
												<td>Tax</td>
...
?>
									...
									<ul class="checkout-types">
										<li>
											<button type="button" title="Proceed to Checkout" class="button btn-proceed-checkout btn-checkout" onclick="submitFrm({<?php echo $arrPromo['response']==1 ? "promo_code:'".$_POST['promo_code']."',cart_total:'".$subtotal."'" : "data:''"?>},'https://lemontreeclothing.com/?page=checkout');"><span>Proceed to Checkout</span></button>
										</li>
									</ul>
								</div>
								<br/>
