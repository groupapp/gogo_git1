			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<form enctype="multipart/form-data" action="bang_action.php" method="post" role="form">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="edit_bang.php?action=add" class="ajax"><button id="sample_editable_1_new" class="btn green">
										...
										<div class="btn-group">
											...
											Delete<i style="margin-left:5px" class="fa fa-trash-o"></i> </a>
											</button>
						...
						<?php
						$strSQL = "SELECT * FROM bangs_vendors";
						$DB->query($strSQL);
						while ($data = $DB->fetch_array($DB->res)){
						
							echo '<tr class="odd gradeX">
								<td>
									<input type="checkbox" class="checkboxes" name="delid[]" value="'.$data['id_bangs'].'"/>
								</td>
								<td>
									 '.$data['from_date'].'
								</td>
								...
								<td>
									<a href="edit_bang.php?id_bangs='.$data['id_bangs'].'&action=update" class="ajax"><button id="sample_editable_1_new" class="btn green">
