	...
	<div id='content'>
        ...
        function createElements(theme) {
			...
			$('#window5').jqxWindow({ height: 460, width: 520, theme: theme, position: { x: offset.left + 150, y: offset.top + 150} });
        ...
        //$("#incoterms").on('click', function () {
			...
			$(document).ready(function () {
				...
				// Create a jqxMenu
                $("#jqxMenu").jqxMenu({ width: '1200', height: '30px', autoOpen: false, autoCloseOnMouseLeave: true, showTopLevelArrows: true, theme: theme });
...
//-----------------------------------------------------------------------
           ...
           // initialize jqxGrid
            ...
            // create new row.
			//color_addrowbutton
            $("#color_updaterowbutton").on('click', function () {
...
//==============incoterms start=================================================
    ...
    $('#window1').on('open', function (event) {    
           ...
           // initialize jqxGrid
			...
			//incoterms_addrowbutton
            $("#incoterms_updaterowbutton").on('click', function () {
...
//==============shipvia start=================================================
       ...
       $('#window2').on('open', function (event) { 
           ...
           // initialize jqxGrid
            ...
            // create new row.
            // create new row.  shipvia_addrowbutton
            $("#shipvia_updaterowbutton").on('click', function () {
...
//==============category start=================================================
    ...
    $('#window3').on('open', function (event) { 
           ...
           // initialize jqxGrid
            ...
            // create new row.
            // create new row. category_addrowbutton
            $("#category_updaterowbutton").on('click', function () {
	...
	$('#window4').on('open', function (event) { 
			...
			var salestax_generaterow = function (id) {
               ...
               //alert(id);
				...
				row["rate"] =0.00;//jQuery("#salestax_rate").val();
                //row["description"] = firstNames[firtnameindex];
           ...
           // initialize jqxGrid
            ...
            // create new row.
            // create new row.    salestax_addrowbutton
            $("#salestax_updaterowbutton").on('click', function () {
     ...
     $('#window5').on('open', function (event) { 
			...
			var term_generaterow = function (id) {
               ...
               //alert(id);
				...
				row["type"] ='';//jQuery("#term_due_no_day").val();
				row["value"] =0;//jQuery("#term_due_nextmonth_day").val();
           ...
           // initialize jqxGrid
			...
			var items = new Array();
            items.push('Due in number od days');
			items.push('Due ont the day of next month');
			items.push('Due on the day of next next month');
			$("#term_jqxgrid").jqxGrid(
            {
                ...
                columns: [
					  ...
					  { text: 'Type', filtertype: 'list', filteritems: items, columntype: 'dropdownlist',datafield: 'type', width: 240,align: 'center',cellsalign: 'left',
					  createeditor: function (row, cellvalue, editor) {
								var dataSource = ['Due in number od days', 'Due ont the day of next month', 'Due on the day of next next month'];
								editor.jqxDropDownList({source: dataSource });
							}
						},
					  
					  { text: 'Value', datafield: 'value', width: 84,align: 'center',cellsalign: 'right', cellsformat: 'n2' ,rendered: tooltiprenderer},
            ...
            // create new row.
            // create new row.  term_addrowbutton
            $("#term_updaterowbutton").on('click', function () {
...
//==============size start=================================================
      ...
      $('#window6').on('open', function (event) { 
           ...
           // initialize jqxGrid
            ...
            // create new row.
            // create new row.  size_addrowbutton
            $("#size_updaterowbutton").on('click', function () {
				...
				$.ajax({
                            ...
                            success: function (data) {
							   // insert command is executed.
								...
								$("#user_jqxgrid").jqxGrid('addrow', null, datarow);				
								$("#user_id").val('');
								$("#user_id").hide();
								$("#pass").val('');
								$("#pass").hide();
...
<body class='default' style="width:1200px;">
		
		<div id='jqxWidget' style='height: 20px;'>
            <div  id='jqxMenu' style='visibility: hidden; width:1200px; margin-left: 20px;'>
                <ul>
                    <li><a href="#Home">Home</a></li>
                    <li>Basic Data
                        <ul style='width: 170px;' class='megamenu-ul'>
                            <li ignoretheme='true' style="margin:5px; "><a href='?position=company' target="company" style="text-decoration: none;color: black;">Company</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=customer' target="customer" style="text-decoration: none;color: black;">Customer/Vendor</a></li>
                            ...
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=garment' target="garment" style="text-decoration: none;color: black;">Garment</a></li>
							<li ignoretheme='true' style="margin:5px;"><a href='?position=glaccount' target="account" style="text-decoration: none;color: black;">Chart of Account</a></li>
                        </ul>
                    </li>
                    <li>Code
					<ul style='width: 170px;' class='megamenu-ul'>
					...
					<li>PO
                        <ul style='width: 170px;' class='megamenu-ul'>
                            ...
                            <li ignoretheme='true'style="margin:5px;"><a href='?position=garment_po'  style="text-decoration: none;color: black;" onclick="return OpenOrFocus(this, 'garment_po');">Full Package Garment</a></li>
							...
							<li ignoretheme='true'style="margin:5px;"><a href='?position=non_po' target="non_po" style="text-decoration: none;color: black;">Non-Inventory</a></li>
                        </ul>
                    </li>
					<li>Purchase
                        <ul style='width: 170px;' class='megamenu-ul'>
                            ...
                            <li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Finished Fabric</a></li>
                            <li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Fabric Processing</a></li>
                            <li ignoretheme='true'style="margin:5px;"><a href='?position=garment_purchase' target="garment_purchase" style="text-decoration: none;color: black;">Full Package Garment</a></li>
							<li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Cutting</a></li>
                            <li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Sewing</a></li>
                            <li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Cut & Sew</a></li>
                            <li ignoretheme='true'style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Embellishing</a></li>
							<li ignoretheme='true'style="margin:5px;"><a href='?position=non_purchase' target="non_purchase"style="text-decoration: none;color: black;">Non-Inventory</a></li>
                        </ul>
                    </li>
					<li>Quotation
                        <ul style='width: 170px;' class='megamenu-ul'>
					...
					<li>Sales Order
                        <ul style='width: 170px;' class='megamenu-ul'>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Yarn</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Fabric</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=garment_so' target="garment_so" style="text-decoration: none;color: black;">Full Package Garment</a></li>
							<li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Trim</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Garment</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Non-Inventory</a></li>
                        </ul>
					...
					<li>Invoice
                        <ul style='width: 170px;' class='megamenu-ul'>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Yarn</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Fabric</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=garment_invoice' target="garment_invoice" style="text-decoration: none;color: black;">Full Package Garment</a></li>
							<li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Trim</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Garment</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Non-Inventory</a></li>
                        </ul>
                    ...
                    <li>Account
                        <ul style='width: 170px;' class='megamenu-ul'>
                            ...
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=garment_payment' target="_blank" style="text-decoration: none;color: black;">Payment</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='#' style="text-decoration: none;color: black;">Payroll Post</a></li>
                            <li ignoretheme='true' style="margin:5px;"><a href='?position=journal'  target="journal" style="text-decoration: none;color: black;">General Journal</a></li>
